...
@Component({
  ...
  template: `
    <header class="topbar">
      ...
      <nav><a routerLink="/" routerLinkActive="active" [routerLinkActiveOptions]="{exact: true}">New review</a><a routerLink="/history" routerLinkActive="active">History</a><a routerLink="/agent-lab" routerLinkActive="active">Agent lab</a></nav>
